...
4. 发布流程向平台 release service 申请 OSS 预签名上传地址
5. GitHub Actions 把安装包和 updater 签名直接上传到国内 OSS/CDN，并回写对象 key、sha256 与 minisign 签名
6. 所有平台产物上传完成后，发布流程调用 release service 的 publish 接口
7. Jenkins 校验 GitHub 四类安装包和公开更新接口中的最终版本
...
{
  "version": "0.1.102",
  "url": "https://download.baijimu.com/bridge-agent/releases/bridge-agent-v0.1.102/Baijimu_0.1.102_universal.app.tar.gz",
  "signature": "<minisign signature>",
  "notes": "百积木 bridge-agent-v0.1.102",
  ...
  "assets": [
    {
      ...
      "downloadUrl": "https://download.baijimu.com/bridge-agent/releases/bridge-agent-v0.1.28/%E7%99%BE%E7%A7%AF%E6%9C%A8_0.1.28_universal.dmg",
      "sha256": "..."
    }
  ]
}
...
- `POST /releases/{tag}/assets/complete`：安装包上传 OSS 成功后，回写固定公开 `downloadUrl`、`objectKey`、`sha256`、`sizeBytes`，updater 产物同时回写 `signature`
...
```json
{
  ...
  "objectKey": "bridge-agent/releases/bridge-agent-v0.1.28/%E7%99%BE%E7%A7%AF%E6%9C%A8_0.1.28_universal.dmg",
  "downloadUrl": "https://download.baijimu.com/bridge-agent/releases/bridge-agent-v0.1.28/%E7%99%BE%E7%A7%AF%E6%9C%A8_0.1.28_universal.dmg",
  "resourceUrl": "https://download.baijimu.com/bridge-agent/releases/bridge-agent-v0.1.28/%E7%99%BE%E7%A7%AF%E6%9C%A8_0.1.28_universal.dmg"
}
```
