...
pub use connector::{
    ...
    install_connector_from_path_with_provenance, is_connector_package_stop_error, list_connectors,
    load_connector_manifest, local_app_starts_automatically, prepare_installed_connector_runtime,
    ...
    ConnectorIcon, ConnectorInstallProvenance, ConnectorInstallRecord, ConnectorInstallResult,
    ...
    ConnectorSyncFailure, ConnectorSyncReport, ConnectorUi, ConnectorUninstallOptions,
    PythonRuntimeStatus,
};
